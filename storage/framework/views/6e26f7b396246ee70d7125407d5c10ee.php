    ...
    <div class="overflow-hidden position-relative">
        <div class="inline_product clickable">
            ...
            <a href="<?php echo e(route('product',$product->slug)); ?>">
                <img src="<?php echo e(getStorageImages(path: $product->thumbnail_full_url, type: 'product')); ?>" alt="">
            </a>
...
<?php /**PATH C:\Users\musas\Desktop\softwares\6valley\POSA-latest version\POSA\resources\themes\default/web-views/partials/_feature-product.blade.php ENDPATH**/ ?>