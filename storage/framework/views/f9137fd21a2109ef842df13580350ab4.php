<form action="<?php echo e(route('admin.pos.place-order')); ?>" method="post" id='order-place'>
    <?php echo csrf_field(); ?>
    <div id="cart">
            ...
            <table class="table table-align-middle m-0">
                ...
                <?php $__currentLoopData = $cartItems['cartItemValue']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(is_array($item)): ?>
                            ...
                            <td>
                                <div class="media d-flex align-items-center gap-10">
                                    <img class="avatar avatar-sm"
                                        src="<?php echo e(getStorageImages(path:$item['image'], type: 'backend-product')); ?>"
                                    ...
                                    <div class="media-body">
                                        <h5 class="text-hover-primary mb-0 d-flex flex-wrap gap-2">
                                            ...
                                            <?php if($item['tax_model'] == 'include'): ?>
                                                <span class="" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="<?php echo e(translate('tax_included')); ?>">
                            ...
                            <td>
                                <input type="text" inputmode="numeric" pattern="[0-9]*" data-key="<?php echo e($key); ?>" class="form-control qty action-pos-update-quantity w-max-content" value="<?php echo e($item['quantity']); ?>" min="1"
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    <a href="javascript:" data-id="<?php echo e($item['id']); ?>" data-variant ="<?php echo e($item['variant']); ?>" class="btn btn-danger rounded-circle icon-btn remove-from-cart">
        ...
        <div class="pt-4 pb-60">
            <dl>
                ...
                <div class="d-flex gap-2 border-top justify-content-between pt-2">
                    ...
                    <dd class="font-weight-bold title-color"><?php echo e(setCurrencySymbol(amount: usdToDefaultCurrency(amount: ($cartItems['total'] + $cartItems['totalTax'] - $cartItems['couponDiscount'])), currencyCode: getCurrencyCode())); ?></dd>
                </div>
            </dl>
            ...
            <div class="p-4 bg-section rounded mt-4">
                <div>
                    ...
                    <ul class="list-unstyled option-buttons d-flex flex-wrap gap-2 align-items-center">
                        <li>
                            ...
                            <label for="cash" class="btn btn-outline-dark btn-sm mb-0"><?php echo e(translate('cash')); ?></label>
                        </li>
                        <li>
                            <input type="radio" value="card" id="card" name="type" hidden>
                            <label for="card" class="btn btn-outline-dark btn-sm mb-0"><?php echo e(translate('card')); ?></label>
                        </li>
                        ...
                        <li class="<?php echo e((str_contains(session('current_user'), 'walking-customer')) ? 'd-none':''); ?>">
                            ...
                            <label for="wallet" class="btn btn-outline-dark btn-sm mb-0"><?php echo e(translate('wallet')); ?></label>
                        </li>
                        <?php endif; ?>
                    </ul>
                </div>
                <div class="cash-change-amount cash-change-section">
                    <div class="d-flex gap-2 justify-content-between align-items-center pt-4">
                        ...
                        <dd>
                            <input type="number" class="form-control text-end pos-paid-amount-element remove-spin" placeholder="<?php echo e(translate('ex')); ?>: 1000"
                            value="<?php echo e(usdToDefaultCurrency(amount: $cartItems['total']+$cartItems['totalTax']-$cartItems['couponDiscount'])); ?>"
                            name="paid_amount"
        ...
        <div class="d-flex gap-3 align-items-center pt-3 bottom-absolute-buttons z-1">
            <?php if($cartItems['countItem']): ?>
                ...
                <button id="submit_order" type="button" class="btn btn-primary btn-block m-0 action-form-submit" data-message="<?php echo e(translate('want_to_place_this_order').'?'); ?>" data-bs-toggle="modal" data-bs-target="#paymentModal">
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\musas\Desktop\softwares\6valley\POSA-latest version\POSA\resources\views/admin-views/pos/partials/_cart.blade.php ENDPATH**/ ?>