            ...
            <div class="modal-body px-20 py-0 mb-30">
                ...
                <div class="d-flex justify-content-center gap-3">
                    ...
                    <button type="button" class="btn btn-primary max-w-120 flex-grow-1" id="toggle-modal-ok-button"
                        data-bs-dismiss="modal"><?php echo e(translate('yes')); ?></button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-body px-20 py-0 mb-30">
                ...
                <div class="d-flex justify-content-center gap-3">
                    ...
                    <button type="button" class="btn btn-primary max-w-120 flex-grow-1 toggle-status-modal-button-text"
                        id="toggle-status-modal-ok-button" data-bs-dismiss="modal"><?php echo e(translate('yes')); ?></button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-body px-20 py-0 mb-30">
                ...
                <div class="d-flex justify-content-center gap-3 mt-4">
                    <button type="button" class="btn bg-light text-dark min-w-120 border-0"
                        data-bs-dismiss="modal"><?php echo e(translate('Not_Now')); ?></button>
                    <button type="button"
                        ...
                        data-bs-dismiss="modal"><?php echo e(translate('Yes_on')); ?></button>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="success-modal" tabindex="-1" aria-labelledby="toggle-modal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg">
            ...
            <div class="modal-body px-20 py-0 mb-30">
                <div class="d-flex flex-column align-items-center text-center mb-30">
                    <img src="<?php echo e(dynamicAsset(path: 'public/assets/new/back-end/img/icons/modal-success-logo.png')); ?>" width="80" class="mb-20" alt="">
                ...
                <div class="d-flex justify-content-center gap-3">
                    <button type="button" class="btn btn-primary max-w-180 flex-grow-1"
                        data-bs-dismiss="modal"><?php echo e(translate('Okay, Got it')); ?></button>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\musas\Desktop\softwares\6valley\POSA-latest version\POSA\resources\views/layouts/admin/partials/_toggle-modal.blade.php ENDPATH**/ ?>