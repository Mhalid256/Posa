                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center flex-wrap gap-5">
                            ...
                            <?php else: ?>
                                <div class="text-start">
                                    <img src="<?php echo e(getStorageImages(path:$shop->image_full_url,type: 'backend-basic')); ?>"
...
<?php echo $__env->make('layouts.vendor.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\musas\Desktop\softwares\6valley\POSA-latest\POSA\resources\views/vendor-views/shop/index.blade.php ENDPATH**/ ?>