<div>
    <h6 class="font-semibold fs-13 mb-1"><?php echo e(translate('price')); ?></h6>
    <div>
        <div class="d-flex align-items-end gap-2 mt-1">
            <div class="form-group mb-0">
                <label for="min_price" class="mb-1 fs-12 fw-semibold"><?php echo e(translate('Min')); ?></label>
                <input type="number" id="min_price" name="min_price" class="form-control form-control--sm bg-black-09"
                       placeholder="<?php echo e(session('currency_symbol')); ?><?php echo e('0'); ?>">
            </div>
            <div class="mb-2">-</div>
            <div class="form-group mb-0">
                <label for="max_price" class="mb-1 fs-12 fw-semibold"><?php echo e(translate('Max')); ?></label>
                <input type="number" id="max_price" name="max_price" class="form-control form-control--sm bg-black-09"
                       placeholder="<?php echo e(session('currency_symbol')); ?><?php echo e(getProductMaxUnitPriceRange(type: 'web')); ?>">
            </div>
            <button class="btn btn--primary py-1 px-2 fs-13 action-search-products-by-price" id="">
                <i class="text-absolute-white czi-arrow-<?php echo e(session('direction') === "rtl" ? 'left' : 'right'); ?>"></i>
            </button>
        </div>

        <div id="price_range_slider" class="my-3 rounded-10"
             data-max-value="<?php echo e(getProductMaxUnitPriceRange(type: 'web')); ?>" data-min-value="0"
        >
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\musas\Desktop\softwares\6valley\POSA-latest version\POSA\resources\themes\default/web-views/products/partials/_filter-product-price.blade.php ENDPATH**/ ?>