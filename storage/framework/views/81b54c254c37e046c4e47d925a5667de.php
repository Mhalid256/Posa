                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                            <h5 class="font-bold m-0 fs-16"><?php echo e(translate('profile_Info')); ?></h5>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu delete-account-dropdown-menu">
                                        <a class="dropdown-item call-route-alert" href="javascript:"
                                           data-route="<?php echo e(route('account-delete',[$customerDetail['id']])); ?>"
                                           data-message="<?php echo e(translate('want_to_delete_this_account')); ?>?">
                            ...
                            <form class="mt-3 px-sm-2 pb-2" action="<?php echo e(route('user-update')); ?>" method="post"
                                ...
                                <div class="profile--info mb-4">
                                    <div class="position-relative profile-img mb-3">
                                        <img id="blah" alt=""
                                             src="<?php echo e(getStorageImages(path: $customerDetail->image_full_url, type: 'avatar')); ?>">
                                    ...
                                    <h5 class="text-capitalize fs-16 font-bold">
                                        <?php echo e($customerDetail['f_name']. ' '.$customerDetail['l_name']); ?>
                                ...
                                <div class="row g-3">
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="firstName"
                                               class="mb-2 text-capitalize"><?php echo e(translate('first_name')); ?> </label>
                                        <input type="text" class="form-control" id="f_name" name="f_name"
                                               value="<?php echo e($customerDetail['f_name']); ?>" required>
                                    </div>
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="lastName"
                                               class="mb-2 text-capitalize"> <?php echo e(translate('last_name')); ?> </label>
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        ...
                                        <input class="form-control phone-input-with-country-picker" id="phone" type="text"
                                               value="<?php echo e($userCountryAndPhone); ?>" placeholder="<?php echo e(translate('enter_phone_number')); ?>" required
                                            <?php echo e($customerDetail['is_phone_verified'] ? 'disabled' : ''); ?>>

                                        <div class="">
                                            <input type="hidden" class="country-picker-phone-number w-50" name="phone" value="<?php echo e($customerDetail['phone']); ?>" readonly>
                                        </div>

                                        <?php if($customerDetail['phone'] && getLoginConfig(key: 'phone_verification')): ?>
                                            <?php if($customerDetail['is_phone_verified']): ?>
                                                <span class="position-absolute inset-inline-end-10px cursor-pointer" data-toggle="tooltip" data-placement="top" title="<?php echo e(translate('Your_phone_is_verified')); ?>">
                                                    <img width="16"
                                                         src="<?php echo e(theme_asset('public/assets/front-end/img/icons/verified.svg')); ?>"
                                                         class="dark-support" alt="">
                                                </span>
                                            <?php else: ?>
                                                <span class="position-absolute inset-inline-end-10px cursor-pointer" data-toggle="tooltip" data-placement="top"
                                                      title="<?php echo e(translate('Phone_not_verified.')); ?> <?php echo e(translate('Please_verify_through_the_user_app')); ?>">
                                                    <img width="16"
                                                         src="<?php echo e(theme_asset('public/assets/front-end/img/icons/verified-error.svg')); ?>"
                                                         class="dark-support" alt="">
                                                </span>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="inputEmail4"
                                               class="mb-2 text-capitalize"><?php echo e(translate('email')); ?> </label>
                                        <div class="position-relative d-flex align-items-center">
                                            <input type="email" class="form-control" id="account-email" name="email" value="<?php echo e($customerDetail['email']); ?>">
                                            <?php if($customerDetail['email'] && getLoginConfig(key: 'email_verification')): ?>
                                                <?php if($customerDetail['is_email_verified']): ?>
                                                    <span class="position-absolute inset-inline-end-10px cursor-pointer" data-toggle="tooltip" data-placement="top" title="<?php echo e(translate('Your_email_is_verified')); ?>">
                                                            <img width="16"
                                                                 src="<?php echo e(theme_asset('public/assets/front-end/img/icons/verified.svg')); ?>"
                                                                 class="dark-support" alt="">
                                                    </span>
                                                <?php else: ?>
                                                    <span class="position-absolute inset-inline-end-10px cursor-pointer" data-toggle="tooltip" data-placement="top"
                                                          title="<?php echo e(translate('Email_not_verified.')); ?> <?php echo e(translate('Please_verify_through_the_user_app.')); ?>">
                                                            <img width="16"
                                                                 src="<?php echo e(theme_asset('public/assets/front-end/img/icons/verified-error.svg')); ?>"
                                                                 class="dark-support" alt="">
                                                    </span>
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="si-password"
                                               class="mb-2 text-capitalize"><?php echo e(translate('new_password')); ?></label>
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="newPass"
                                               class="mb-2 text-capitalize"><?php echo e(translate('confirm_password')); ?> </label>
                                        <div class="password-toggle rtl">
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\musas\Desktop\softwares\6valley\POSA-latest version\POSA\resources\themes\default/web-views/users-profile/user-account.blade.php ENDPATH**/ ?>