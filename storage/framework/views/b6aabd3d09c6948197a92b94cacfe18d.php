...
<div class="navbar-tool dropdown me-2 <?php echo e(Session::get('direction') === "rtl" ? 'mr-md-3' : 'ml-md-3'); ?>">
    <?php if($web_config['guest_checkout_status'] || auth('customer')->check()): ?>
        ...
        <a class="navbar-tool-text ms-2"
           href="<?php echo e(route('shop-cart')); ?>"><small><?php echo e(translate('my_cart')); ?></small>
            <span class="cart-total-price font-bold fs-14">
                <?php echo e(webCurrencyConverter(amount: \App\Utils\CartManager::getCartListTotalAppliedDiscount($cart))); ?>

            </span>
        </a>
    <?php else: ?>
        <a class="navbar-tool-icon-box bg-secondary dropdown-toggle" href="<?php echo e(route('customer.auth.login')); ?>">
            <span class="navbar-tool-label">
                <?php echo e($cart->count()); ?>
        ...
        <a class="navbar-tool-text ms-2"
           href="<?php echo e(route('customer.auth.login')); ?>">
            <small><?php echo e(translate('my_cart')); ?></small>
            <span class="cart-total-price font-bold fs-14">
                <?php echo e(webCurrencyConverter(amount: \App\Utils\CartManager::getCartListTotalAppliedDiscount($cartList))); ?>

            </span>
        </a>
    <?php endif; ?>

    <div class="dropdown-menu dropdown-menu-<?php echo e(session('direction') === "rtl" ? 'left' : 'right'); ?> __w-20rem cart-dropdown py-0">
        <div class="widget widget-cart px-3 pt-2 pb-3">
            ...
            <?php if($cart->count() > 0): ?>
                ...
                <div class="dropdown-saved-amount text-center  align-items-center justify-content-center text-accent mb-3 <?php echo e($totalSavedAmount <= 0 ? 'd-none' : 'd-flex'); ?>">
                    <img src="<?php echo e(theme_asset(path: 'public/assets/front-end/img/party-popper.svg')); ?>" class="mr-2" alt="">
                    <small>
                        <?php echo e(translate('you_have_saved')); ?>

                        <span class="total_discount">
                            <?php echo e(webCurrencyConverter(amount: $totalSavedAmount)); ?>
                            ...
                            <div class="media">
                                <a class="d-block me-2 position-relative overflow-hidden"
                                   href="<?php echo e(route('product',$cartItem['slug'])); ?>">
                                    <img width="64" class="<?php echo e($product ? ($product->status == 0?'blur-section':'') : 'blur-section'); ?>"
                                ...
                                <div
                                    class="media-body min-height-0 d-flex align-items-center <?php echo e($product ? ($product->status == 0?'blur-section':'') : 'blur-section'); ?>">
                                        ...
                                        <div class="widget-product-meta">
                                            <span
                                                class="text-muted me-2">x <span
                                                    class="cart_quantity_multiply<?php echo e($cartItem['id']); ?>"><?php echo e($cartItem['quantity']); ?></span></span>
                                            <span class="text-accent me-2 discount_price_of_<?php echo e($cartItem['id']); ?>">
                                    ...
                                    <?php if( isset($product->status) && $product->status == 1): ?>
                                        <div class="__quantity">
                                            <div class="quantity__minus cart-qty-btn action-update-cart-quantity"
                                                ...
                                                data-event="minus"
                                                >
                                                <?php if($getProductCurrentStock < $cartItem['quantity'] || $cartItem['quantity'] == (isset($product->minimum_order_qty) ? $product->minimum_order_qty : 1)): ?>
                                            ...
                                            <input type="text"
                                                class="quantity__qty cart-qty-input form-control p-0 text-center cartQuantity<?php echo e($cartItem['id']); ?> action-update-cart-quantity"
                                                ...
                                                data-action="0"
                                                data-event=""
                                               data-current-stock="<?php echo e($getProductCurrentStock); ?>"
                ...
                <?php if($free_delivery_status['status'] && (session()->missing('coupon_type') || session('coupon_type') !='free_delivery')): ?>
                    <div class="py-3">
                        <img src="<?php echo e(theme_asset(path: 'public/assets/front-end/img/truck.svg')); ?>" alt="">
                        <span
                            class="amount_fullfill text-accent __text-12px <?php echo e($free_delivery_status['amount_need'] <= 0 ? '' :'d-none'); ?>"><?php echo e(translate('you_Get_Free_Delivery_Bonus')); ?></span>
                        <small
                            class="amount_need_to_fullfill <?php echo e($free_delivery_status['amount_need'] <= 0 ? 'd-none' :''); ?>"><span
                                class="text-accent __text-12px free_delivery_amount_need"><?php echo e(webCurrencyConverter(amount: $free_delivery_status['amount_need'])); ?></span> <?php echo e(translate('add_more_for_free_delivery')); ?>

                        </small>
                        <div class="progress __progress bg-DFEDFF">
                            <div class="progress-bar"
                                 style="width: <?php echo e($free_delivery_status['percentage']); ?>%; background:var(--primary-clr)"></div>
                        </div>
                    </div>
                <?php endif; ?>
                <div class="d-flex flex-wrap justify-content-between align-items-center pb-2">
                    <div
                        ...
                        <span
                            class="text-accent font-size-base cart_total_amount <?php echo e(Session::get('direction') === "rtl" ? 'mr-1' : 'ml-1'); ?>">
                                <?php echo e(webCurrencyConverter(amount: $sub_total)); ?>
                    ...
                    <?php else: ?>
                        <a class="btn btn-outline-secondary btn-sm" href="<?php echo e(route('customer.auth.login')); ?>">
                            <?php echo e(translate('expand_cart')); ?><i
                                class="czi-arrow-<?php echo e(Session::get('direction') === "rtl" ? 'left mr-1 ml-n1' : 'right ml-1 mr-n1'); ?>"></i>
                        </a>
                    <?php endif; ?>
                ...
                <?php if($web_config['guest_checkout_status'] || auth('customer')->check()): ?>
                    <a class="btn btn--primary btn-sm btn-block font-bold rounded text-capitalize"
                       href="<?php echo e(route('checkout-details')); ?>">
            ...
            <?php else: ?>
                <div class="widget-cart-item">
                    <div class="text-center text-capitalize">
                        <img class="mb-3 mw-100" src="<?php echo e(theme_asset(path: 'public/assets/front-end/img/icons/empty-cart.svg')); ?>"
                             alt="<?php echo e(translate('cart')); ?>" loading="eager">
...
<?php /**PATH C:\Users\musas\Desktop\softwares\6valley\POSA-latest version\POSA\resources\themes\default/layouts/front-end/partials/_cart.blade.php ENDPATH**/ ?>