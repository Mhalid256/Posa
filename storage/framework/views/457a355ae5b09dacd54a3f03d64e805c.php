<audio id="myAudio">
    <source src="<?php echo e(dynamicAsset(path: 'public/assets/front-end/sound/notification.mp3')); ?>" type="audio/mpeg">
</audio>

<div class="alert--container active">
    <?php if(env('APP_MODE') == 'demo'): ?>
        <div class="alert alert--message-2 alert-dismissible fade show" id="demo-reset-warning">
            <img width="28" class="align-self-start" src="<?php echo e(theme_asset(path: 'assets/front-end/img/info-2.png')); ?>" alt="">
            <div class="w--0">
...
<?php /**PATH C:\Users\musas\Desktop\softwares\6valley\POSA-latest version\POSA\resources\themes\default/layouts/front-end/partials/_alert-message.blade.php ENDPATH**/ ?>