<?php
    ...
    // ── Resolve the correct vendor regardless of guard ──────────────────
                ...
                <a class="navbar-brand" href="<?php echo e(route('vendor.dashboard.index')); ?>" aria-label="">
                    <?php if(isset($shop)): ?>
                        <img class="navbar-brand-logo"
                             src="<?php echo e(getStorageImages(path: $shop->image_full_url,type:'backend-logo')); ?>"
                                        ...
                                        <?php $__currentLoopData = json_decode($lang['value'],true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($data['status']==1): ?>
                                                <li class="change-language" data-action="<?php echo e(route('change-language')); ?>"
                                                    ...
                                                    <a class="dropdown-item pb-1 <?php echo e($data['code']==$local ? 'active' : ':'); ?>"
                                                       href="javascript:">
                    ...
                    <li class="nav-item">
                        <div class="hs-unfold">
                            <a title="<?php echo e(translate('website_shop_view')); ?>"
                               ...
                               href="<?php echo e(route('shopView', ['id' => $shop->id ?? 0])); ?>"
                               title="<?php echo e(translate('Website View')); ?>" data-toggle="tooltip"
                        ...
                        <div class="hs-unfold">
                            <a
                                ...
                                data-hs-unfold-options='{
                                     ...
                                     "type": "css-animation"
                                   }' title="<?php echo e(translate('Notifications')); ?>" data-toggle="tooltip"
                                data-custom-class="header-icon-title">
                                <i class="tio-notifications-on-outlined"></i>
                                <?php ($notification=App\Models\Notification::whereBetween('created_at', [$vendor->created_at, Carbon::now()])->where('sent_to', 'seller')->whereDoesntHave('notificationSeenBy')->count()); ?>
                                <?php if($notification != 0): ?>
                                    <span class="btn-status btn-sm-status btn-status-danger notification_data_new_count"><?php echo e($notification); ?></span>
                                <?php endif; ?>
                            </a>
                            <div id="notificationDropdown"
                                ...
                                <?php ($notification_data=App\Models\Notification::whereBetween('created_at', [$vendor->created_at, Carbon::now()])->where('sent_to', 'seller')->with('notificationSeenBy')->latest()->get()); ?>
                                <?php $__currentLoopData = $notification_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <span class="text-truncate pr-2 d-block"
                                        ...
                                        <?php if($item->notification_seen_by == null): ?>
                                            <span
                                                class="badge-soft-danger float-right small py-1 px-2 rounded notification_data_new_badge<?php echo e($item->id); ?>"><?php echo e(translate('new')); ?></span>
                                        <?php endif; ?>
                                    </button>
                    ...
                    <li class="nav-item">
                        <div class="hs-unfold">
                            <a
                                ...
                                title="<?php echo e(translate('Inbox')); ?>" data-toggle="tooltip"
                                data-custom-class="header-icon-title"
                            >
                                <svg width="20" height="21" viewBox="0 0 20 21" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                ...
                                <?php ($message=\App\Models\Chatting::where(['seen_by_seller'=>0, 'seller_id'=>$vendorId])->count()); ?>
                                <?php if($message!=0): ?>
                            ...
                            <div id="messageDropdown"
                                ...
                                <a class="dropdown-item position-relative"
                                   href="<?php echo e(route('vendor.messages.index', ['type' => 'customer'])); ?>">
                                    ...
                                    <?php ($messageCustomer=\App\Models\Chatting::where(['seen_by_seller'=>0, 'seller_id'=>$vendorId])->whereNotNull(['user_id'])->count()); ?>
                                    <?php if($messageCustomer > 0): ?>
                                        <span class="btn-status btn-sm-status-custom btn-status-danger"><?php echo e($messageCustomer); ?></span>
                                    <?php endif; ?>
                                </a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item position-relative"
                                   href="<?php echo e(route('vendor.messages.index', ['type' => 'delivery-man'])); ?>">
                                    ...
                                    <?php ($messageDeliveryMan=\App\Models\Chatting::where(['seen_by_seller'=>0, 'seller_id'=>$vendorId])->whereNotNull(['delivery_man_id'])->count()); ?>
                    ...
                    <li class="nav-item">
                        <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker btn btn-icon btn-ghost-secondary rounded-circle"
                               ...
                               title="<?php echo e(translate('pending_Orders')); ?>" data-toggle="tooltip"
                               data-custom-class="header-icon-title">
                                <svg width="20" height="21" viewBox="0 0 20 21" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                ...
                                <?php ($order=\App\Models\Order::where(['seller_is'=>'seller','seller_id'=>$vendorId, 'order_status'=>'pending'])->count()); ?>
                                <?php if($order!=0): ?>
                        ...
                        <div class="hs-unfold">
                               ...
                               data-hs-unfold-options='{
                                ...
                                <div class="d-none d-md-block media-body text-right">
                                    <h5 class="profile-name mb-0">
                                        <?php echo e($isEmployee ? ($employee->f_name . ' ' . $employee->l_name) : $vendor->name); ?>

                                        <?php if($isEmployee): ?>
                                            <span class="badge badge-warning ml-1" style="font-size:10px"><?php echo e(translate('staff')); ?></span>
                                        <?php endif; ?>
                                    </h5>
                                    <span class="fs-12"><?php echo e(Str::limit($shop->name ?? '', 20)); ?></span>
                                </div>
                                <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img"
                                         src="<?php echo e(getStorageImages(path:$vendor->image_full_url,type:'backend-profile')); ?>"
                            ...
                            <div id="accountNavbarDropdown"
                                    ...
                                    <div class="media align-items-center text-break">
                                        ...
                                        <div class="media-body">
                                            <span class="card-title h5">
                                                <?php echo e($isEmployee ? $employee->f_name : $vendor->f_name); ?>

                                            </span>
                                            <span class="card-text">
                                                <?php echo e($isEmployee ? $employee->email : $vendor->email); ?>
                                ...
                                <a class="dropdown-item"
                                   href="<?php echo e(route('vendor.profile.update',[$vendorId])); ?>">
                                ...
                                <a class="dropdown-item" href="javascript:" data-toggle="modal"
                                   data-target="#sign-out-modal">
                                    <span class="text-truncate pr-2"
                                          title="<?php echo e(translate('logout')); ?>"><?php echo e(translate('logout')); ?></span>
                                </a>
                            </div>
                        </div>
                    </li>
            ...
            <div class="p-3">
                ...
                <div class="bg-white p-1 rounded mt-2">
                    <a title="<?php echo e(('website_shop_view')); ?>" class="p-2 title-color"
                       href="<?php echo e(route('shopView', ['id' => $shop->id ?? 0])); ?>" target="_blank" data-toggle="tooltip"
                       data-custom-class="header-icon-title">
                ...
                <div class="bg-white p-1 rounded mt-2">
                    <a class="p-2 title-color"
                       href="<?php echo e(route('vendor.messages.index', ['type' => 'customer'])); ?>"
                       title="<?php echo e(translate('message')); ?>" data-toggle="tooltip" data-custom-class="header-icon-title">
                        <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_5926_1152)">
                                <path d="M16.6666 2.16699H3.33329C2.41663 2.16699 1.67496 2.91699 1.67496 3.83366L1.66663 18.8337L4.99996 15.5003H16.6666C17.5833 15.5003 18.3333 14.7503 18.3333 13.8337V3.83366C18.3333 2.91699 17.5833 2.16699 16.6666 2.16699ZM4.99996 8.00033H15V9.66699H4.99996V8.00033ZM11.6666 12.167H4.99996V10.5003H11.6666V12.167ZM15 7.16699H4.99996V5.50033H15V7.16699Z" fill="#073B74"/>
                            </g>
                        ...
                        <?php ($message=\App\Models\Chatting::where(['seen_by_seller'=>1,'seller_id'=>$vendorId])->count()); ?>
                        <?php if($message!=0): ?>
                ...
                <div class="bg-white p-1 rounded mt-2">
                    <a class="p-2 title-color"
                       href="<?php echo e(route('vendor.orders.list',['pending'])); ?>" title="<?php echo e(translate('Shopping Cart')); ?>"
...
<div id="headerDouble" class="d-none"></div><?php /**PATH C:\Users\musas\Desktop\softwares\6valley\POSA-latest version\POSA\resources\views/layouts/vendor/partials/_header.blade.php ENDPATH**/ ?>