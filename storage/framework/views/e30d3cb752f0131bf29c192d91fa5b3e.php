            ...
            <div class="modal-body row">
                ...
                <div class="col-md-12">
                    <div class="text-center">
                        ...
                        <a href="<?php echo e(url()->previous()); ?>" class="btn btn-danger non-printable mt-2 mt-lg-0">
...
<?php /**PATH C:\Users\musas\Desktop\softwares\6valley\POSA-latest version\POSA\resources\views/admin-views/pos/partials/modals/_print-invoice.blade.php ENDPATH**/ ?>