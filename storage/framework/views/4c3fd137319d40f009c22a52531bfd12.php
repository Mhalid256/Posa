            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
                ...
                <div class="d-flex gap-3 flex-wrap">
                    <form action="<?php echo e(url()->current()); ?>" method="GET" class="d-flex gap-2">
                        <input type="search" name="searchValue" class="form-control form-control-sm" placeholder="<?php echo e(translate('search_by_name_or_email_or_phone')); ?>" value="<?php echo e(request('searchValue')); ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-3">
                                    <img src="<?php echo e(getStorageImages(path: $employee->image_full_url ?? [], type: 'backend-profile')); ?>" width="40" height="40" class="rounded-circle object-fit-cover" alt="">
                                    <span class="fw-medium"><?php echo e($employee->name); ?></span>
                                </div>
                            </td>
                            ...
                            <td class="text-center">
                                <div class="d-flex gap-2 justify-content-center">
                                    ...
                                    <button type="button" class="btn btn-outline-danger btn-sm" title="<?php echo e(translate('delete')); ?>" onclick="deleteEmployee(<?php echo e($employee->id); ?>)"><i class="fi fi-rr-trash"></i></button>
                                </div>
                            </td>
                        </tr>
...
function deleteEmployee(id) {
    if (!confirm('<?php echo e(translate("are_you_sure_delete_employee")); ?>?')) return;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.vendor.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\musas\Desktop\softwares\6valley\POSA-latest\POSA\resources\views/vendor-views/employee/list.blade.php ENDPATH**/ ?>