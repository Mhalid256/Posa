    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header pt-3 d-flex justify-content-between align-items-center flex-wrap gap-2">
                <h4 class="modal-title"><?php echo e(translate('list_of_hold_orders')); ?></h4>
...
<?php /**PATH C:\Users\musas\Desktop\softwares\6valley\POSA-latest version\POSA\resources\views/admin-views/pos/partials/modals/_hold-orders-modal.blade.php ENDPATH**/ ?>