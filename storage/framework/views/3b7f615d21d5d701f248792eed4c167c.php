...
<?php $__env->startPush('css_or_js'); ?>
    <link rel="stylesheet" href="<?php echo e(dynamicAsset('public/assets/back-end/css/owl.min.css')); ?>"/>
<?php $__env->stopPush(); ?>
    ...
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                <img src="<?php echo e(dynamicAsset('/public/assets/back-end/img/support-ticket.png')); ?>" alt="">
                        ...
                        <form class="search-form mb-4 px-20" id="chat-search-form">
                            <div class="search-input-group">
                                ...
                                <input id="myInput" type="text" aria-label="Search customers..."
                                       placeholder="<?php echo e(request('type') == 'customer' ? translate('search_customers') : translate('search_delivery_men')); ?>...">
                            </div>
                        </form>
                        <ul class="nav nav-tabs gap-3 border-0 mb-3 mx-4" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link bg-transparent p-2 <?php echo e(request('type') == 'customer' ? 'active' : ''); ?>"
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link bg-transparent p-2 <?php echo e(request('type') == 'delivery-man' ? 'active' : ''); ?>"
                        ...
                        <div class="tab-content max-h-100vh-300px overflow-y-auto">
                            <div class="tab-pane fade show active" id="customers" role="tabpanel"
                                ...
                                <div class="inbox_chat d-flex flex-column">
                                    <?php if(isset($allChattingUsers) && count($allChattingUsers) > 0): ?>
                                        <?php $__currentLoopData = $allChattingUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $chatting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($chatting->user_id && $chatting->customer): ?>
                                                <div class="list_filter">
                                                    <div
                                                        class="chat_list p-3 d-flex gap-2 <?php echo e($key == 0 ? 'bg-soft-secondary' : ''); ?> get-ajax-message-view <?php echo e($chatting->user_id == $lastChatUser->id ? 'active' : ''); ?>"
                                                        data-user-id="<?php echo e($chatting->user_id); ?>">
                                                        <div class="chat_people media gap-10 w-100" id="chat_people">
                                                            <div class="chat_img avatar avatar-sm avatar-circle">
                                                                <img
                                                                    src="<?php echo e(getStorageImages(path:$chatting->customer->image_full_url,type: 'backend-profile')); ?>"
                                                                    id="<?php echo e($chatting->user_id); ?>"
                                                            ...
                                                            <div class="chat_ib media-body">
                                                                <h5 class="mb-1 seller <?php echo e($key != 0 ?'font-weight-normal' :''); ?>"
                                                                    id="<?php echo e($chatting->user_id); ?>"
                                                                    data-name="<?php echo e($chatting->customer->f_name.' '.$chatting->customer->l_name); ?>"
                                                                    data-phone="<?php echo e($chatting->customer->phone); ?>">
                                                                    <?php echo e($chatting->customer->f_name .' '. $chatting->customer->l_name); ?>


                                                                    <span
                                                                        class="lead small float-end"><?php echo e($chatting->created_at->diffForHumans()); ?></span>
                                                                </h5>
                                                                <span
                                                                    class="mt-2 font-weight-normal text-muted d-block"
                                                                    id="<?php echo e($chatting->user_id); ?>"
                                                                    data-name="<?php echo e($chatting->customer->f_name .' '. $chatting->customer->l_name); ?>"
                                                                    data-phone="<?php echo e($chatting->customer->phone); ?>"><?php echo e($chatting->customer->phone); ?>

                                                                </span>
                                                                <div
                                                                    class="d-flex gap-2 justify-content-between align-items-center">
                                                                    <p class="fs-12 line--limit-1 mb-0"><?php echo e($chatting?->message ?? 'Shared files'); ?></p>
                                                                    <?php if(array_key_exists($chatting->user_id, $countUnreadMessages)): ?>
                                                                        <span
                                                                            id="count-unread-messages-<?php echo e($chatting->user_id); ?>"
                                                                            ...
                                                                            <?php echo e($countUnreadMessages[$chatting->user_id]); ?>
                                                        ...
                                                        <?php if(!$chatting->seen_by_seller && !($key == 0)): ?>
                                                            <div
                                                                class="message-status bg-danger notify-alert-<?php echo e($chatting->user_id); ?>"></div>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            <?php elseif($chatting->delivery_man_id && $chatting->deliveryMan): ?>
                                                <div class="list_filter">
                                                    <div
                                                        class="chat_list p-3 d-flex gap-2 <?php echo e($key == 0 ? 'bg-soft-secondary' : ''); ?> get-ajax-message-view <?php echo e($chatting->delivery_man_id == $lastChatUser->id ? 'active' : ''); ?>"
                                                        data-user-id="<?php echo e($chatting->delivery_man_id); ?>">
                                                        <div class="chat_people media gap-10 w-100" id="chat_people">
                                                            <div class="chat_img avatar avatar-sm avatar-circle">
                                                                <img
                                                                    src="<?php echo e(getStorageImages(path:$chatting->deliveryMan->image_full_url,type: 'backend-profile')); ?>"
                                                                    id="<?php echo e($chatting->user_id); ?>"
                                                                    class="avatar-img avatar-circle" alt="">
                                                                <span
                                                                    class="avatar-status avatar-sm-status avatar-status-success"></span>
                                                            ...
                                                            <div class="chat_ib media-body">
                                                                <h5 class="mb-1 seller <?php echo e($key != 0 ?'font-weight-normal' :''); ?>"
                                                                    id="<?php echo e($chatting->delivery_man_id); ?>"
                                                                    data-name="<?php echo e($chatting->deliveryMan->f_name.' '.$chatting->deliveryMan->l_name); ?>"
                                                                    data-phone="<?php echo e($chatting->deliveryMan->country_code.$chatting->deliveryMan->phone); ?>">
                                                                    <?php echo e($chatting->deliveryMan->f_name.' '.$chatting->deliveryMan->l_name); ?>
                                                                ...
                                                                <span
                                                                    ...
                                                                    id="<?php echo e($chatting->delivery_man_id); ?>"
                                                                    data-name="<?php echo e($chatting->deliveryMan->f_name .' '. $chatting->deliveryMan->l_name); ?>"
                                                                    data-phone="<?php echo e($chatting->deliveryMan->country_code.$chatting->deliveryMan->phone); ?>"><?php echo e($chatting->deliveryMan->country_code.$chatting->deliveryMan->phone); ?>

                                                                </span>
                                                                <div
                                                                    class="d-flex gap-2 justify-content-between align-items-center">
                                                                    <p class="fs-12 line--limit-1 mb-0"><?php echo e($chatting?->message ?? 'Shared files'); ?></p>
                                                                    <?php if(array_key_exists($chatting->delivery_man_id, $countUnreadMessages)): ?>
                                                                        <span id="count-unread-messages-<?php echo e($chatting->delivery_man_id); ?>"
                                                                            class="bg-c1 text-white fs-12 lh-1 rounded-circle aspect-1 min-w-20px p-1 d-flex justify-content-center align-items-center flex-shrink-0">
                                                                            <?php echo e($countUnreadMessages[$chatting->delivery_man_id]); ?>
                                                        ...
                                                        <?php if(!$chatting->seen_by_admin && !($key == 0)): ?>
                                                            <div
                                                                class="message-status bg-danger notify-alert-<?php echo e($chatting->delivery_man_id); ?>"></div>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                        ...
                                        <div class="justify-content-center align-items-center h-100 min-h-300 d-none empty-state-for-chatting-msg">
                                            <div class="d-flex flex-column align-items-center gap-3">
                                                <img src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/empty-state-icon/no-customer-found.svg')); ?>"
                                                     alt="">
                                                <p><?php echo e(translate('No_Customer_Found')); ?></p>
                                            </div>
                                        </div>
                                    <?php else: ?>
                ...
                <div class="card card-body card-chat justify-content-center Chat" id="">
                    <?php if(isset($lastChatUser)): ?>
                            ...
                            <div class="media align-items-center gap-3">
                                ...
                                <div class="media-body">
                                    <h5 class="profile-name mb-1"
                                        id="profile_name"><?php echo e($lastChatUser['f_name'].' '.$lastChatUser['l_name']); ?></h5>
                                    <span class="fs-12"
                                          id="profile_phone"><?php echo e($lastChatUser['country_code']); ?> <?php echo e($lastChatUser['phone']); ?></span>
                                </div>
                            </div>
                            <?php if(Request::is('vendor/messages/index/customer')): ?>
                                <div class="dropdown">
                                    <a class="text--title" href="javascript:" role="button"
                                       id="viewDetailsDropdown"
                                       data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <img width="25" class="svg"
                                             src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/icons/dots.svg')); ?>"
                                             alt="">
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right shadow-lg border p-3 w-0"
                                        ...
                                        <a class="dropdown-item bg-transparent p-0 text-center font-weight-medium user-details-route"
                                           href="<?php echo e(Request::is('vendor/messages/index/customer') ? route('vendor.orders.list', ['status' => 'all', 'filter' => 'all', 'customer_id' => $lastChatUser->id]) : '#'); ?>">
                                            View details
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div
                            ...
                            <?php echo $__env->make('vendor-views.chatting.messages', ['lastChatUser'=>$lastChatUser, 'chattingMessages'=>$chattingMessages], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        ...
                        <div class="type_msg">
                            <div class="input_msg_write">
                                <form class="mt-4 chatting-messages-ajax-form" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" id="current-user-hidden-id" value="<?php echo e($lastChatUser->id); ?>"
                                           name="<?php echo e($userType == 'customer' ? 'user_id' : 'delivery_man_id'); ?>">
                                    <div class="position-relative d-flex">
                                        ...
                                        <label class="w-0 flex-grow-1 uploaded-file-container">
                                            <textarea class="form-control pt-3 radius-left-button pl-105px"
                                                      ...
                                                      placeholder="<?php echo e(translate('send_a_message')); ?>"
                                        ...
                                        <div
                                            ...
                                            <button
                                                ...
                                                <img
                                                    src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/send-icon.png')); ?>"
                                                    alt="">
                                            </button>
                                        </div>
                    ...
                    <?php else: ?>
                        <div class="d-flex justify-content-center align-items-center h-100">
                            <div class="d-flex flex-column align-items-center gap-3">
                                <img src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/empty-message.png')); ?>"
                                     alt="">
                                <p><?php echo e(translate('you_have_not_any_conversation_yet')); ?></p>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
        ...
        <span id="chatting-post-url"
              data-url="<?php echo e(Request::is('vendor/messages/index/customer') ? route('vendor.messages.message').'?user_id=' : route('vendor.messages.message').'?delivery_man_id='); ?>"></span>
        <span id="image-url" data-url="<?php echo e(dynamicAsset('storage/app/public/chatting')); ?>"></span>
    </div>
    <span id="get-file-icon" data-default-icon="<?php echo e(dynamicAsset("public/assets/back-end/img/default-icon.png")); ?>"
          data-word-icon="<?php echo e(dynamicAsset("public/assets/back-end/img/default-icon.png")); ?>"></span>
    <span id="message-media-error" data-text="<?php echo e(translate('File_size_is_too_large')); ?> <?php echo e(translate('Please_upload_a_smaller_file')); ?>"></span>
    <span id="get-video-preview-icon"
          data-icon="<?php echo e(dynamicAsset('public/assets/back-end/img/icons/carbon_play-filled.svg')); ?>"></span>
<?php $__env->stopSection(); ?>

<?php $__env->startPush('script'); ?>
    <script src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/js/vendor/chatting.js')); ?>"></script>
    <script src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/js/picmo-emoji.js')); ?>"></script>
    <script src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/js/emoji.js')); ?>"></script>
    <script src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/js/select-multiple-file.js')); ?>"></script>
    <script src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/js/select-multiple-image-for-message.js')); ?>"></script>
    <script src="<?php echo e(dynamicAsset('public/assets/back-end/js/owl.min.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.vendor.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\musas\Desktop\softwares\6valley\POSA-latest version\POSA\resources\views/vendor-views/chatting/index.blade.php ENDPATH**/ ?>