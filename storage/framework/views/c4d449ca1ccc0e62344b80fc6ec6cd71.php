                    ...
                    <?php if($singleCart['customerOnHold']): ?>
                                                ...
                                                <div class="p-3 item border-bottom rounded d-flex justify-content-between gap-2">
                                                    <div class="media d-flex align-items-center flex-wrap gap-2">
                                                        ...
                                                        <div class="media-body">
                                                            <h5 class="text-truncate"> <?php echo e(Str::limit($item['name'], 12 )); ?></h5>
                                                            <?php if($item['variant']): ?>
                        ...
                        <td>
                            <div class="d-flex justify-content-center gap-2">
                                <button type="button" class="btn bg-warning bg-opacity-10 text-warning action-cart-change" data-cart="<?php echo e($key); ?>">
...
<?php else: ?>
    <div class="d-flex align-items-center justify-content-center h-100">
        <div>
            ...
            <h3 class="text-muted text-center mt-4"><?php echo e(translate('No_Order_Found')); ?></h3>
        </div>
    </div>
<?php endif; ?>
<?php /**PATH C:\Users\musas\Desktop\softwares\6valley\POSA-latest version\POSA\resources\views/admin-views/pos/partials/_view-hold-orders.blade.php ENDPATH**/ ?>