        ...
        <div class="row gy-2">
            ...
            <?php if($walletStatus): ?>
                <input type="hidden" class="form-control customer-wallet-balance"
                       value="<?php echo e(usdToDefaultCurrency(amount: $currentCustomerData?->wallet_balance ?? 0)); ?>"
                       readonly>
            <?php endif; ?>
        </div>
    </div>
...
<?php echo $__env->make('vendor-views.pos.partials._cart', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /**PATH C:\Users\musas\Desktop\softwares\6valley\POSA-latest version\POSA\resources\views/vendor-views/pos/partials/_cart-summary.blade.php ENDPATH**/ ?>