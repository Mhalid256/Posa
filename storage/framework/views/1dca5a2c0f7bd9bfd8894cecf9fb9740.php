...
<div class="width-363px">
    ...
    <table class="table table-bordered mt-3 text-left width-99" style="white-space: normal;">
        <thead>
        <tr>
            <th class="text-center text-uppercase p-0"><?php echo e(translate('qty')); ?></th>
            <th class="text-center text-uppercase p-0"><?php echo e(translate('desc')); ?></th>
            <th class="text-center p-0"><?php echo e(translate('price')); ?></th>
        </tr>
        </thead>
...
<?php /**PATH C:\Users\musas\Desktop\softwares\6valley\POSA-latest version\POSA\resources\views/admin-views/pos/order/invoice.blade.php ENDPATH**/ ?>