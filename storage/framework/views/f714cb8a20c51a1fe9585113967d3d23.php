        ...
        <div class="modal-content shadow-lg">
            ...
            <div class="modal-body px-4 px-sm-5 pt-0">
                ...
                <div class="d-flex justify-content-center gap-3">
                    <button type="button" class="btn btn--primary min-w-120" id="toggle-modal-ok-button" data-dismiss="modal"><?php echo e(translate('ok')); ?></button>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg">
            ...
            <div class="modal-body px-4 px-sm-5 pt-0">
                ...
                <div class="d-flex justify-content-center gap-3">
                    <button type="button" class="btn btn--primary min-w-120" id="toggle-status-modal-ok-button" data-dismiss="modal"><?php echo e(translate('ok')); ?></button>
                    <button type="button" class="btn btn-danger-light min-w-120" data-dismiss="modal"><?php echo e(translate('cancel')); ?></button>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\Users\musas\Desktop\softwares\6valley\POSA-latest version\POSA\resources\views/layouts/vendor/partials/_toggle-modal.blade.php ENDPATH**/ ?>