...
<script src="<?php echo e(theme_asset(path: 'public/assets/front-end/vendor/firebase/firebase.min.js')); ?>"></script>
...
<script>
    try {
        ...
        try {
            ...
            const topics = <?php echo json_encode(getFCMTopicListToSubscribe()); ?>;
            startFCM(topics);
...
<?php /**PATH C:\Users\musas\Desktop\softwares\6valley\POSA-latest version\POSA\resources\themes\default/layouts/front-end/partials/_firebase-script.blade.php ENDPATH**/ ?>