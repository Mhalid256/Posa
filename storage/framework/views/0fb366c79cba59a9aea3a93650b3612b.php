<div class="pos-product-item card action-select-product" data-id="<?php echo e($product['id']); ?>">
    <div class="pos-product-item_thumb position-relative">
        ...
        <?php endif; ?>
        <img class="img-fit" src="<?php echo e(getStorageImages(path:$product->thumbnail_full_url, type: 'backend-product')); ?>"
...
<?php /**PATH C:\Users\musas\Desktop\softwares\6valley\POSA-latest version\POSA\resources\views/vendor-views/pos/partials/_single-product.blade.php ENDPATH**/ ?>