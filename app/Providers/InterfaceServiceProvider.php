...
class InterfaceServiceProvider extends ServiceProvider
{
    ...
    $this->app->bind(
        \App\Contracts\Repositories\VendorRoleRepositoryInterface::class,
        \App\Repositories\VendorRoleRepository::class
        );

    $this->app->bind(
        \App\Contracts\Repositories\VendorEmployeeRepositoryInterface::class,
        \App\Repositories\VendorEmployeeRepository::class
    );
