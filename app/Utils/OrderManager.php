...
class OrderManager
{
    ...
    public static function generate_order($data)
    {
        ...
        $or = [
            ...
            'order_amount' => (function() use ($cart_group_id, $discount, $freeShippingDiscount, $data) {
            $base = CartManager::cart_grand_total(cartGroupId: $cart_group_id, type: 'checked') - $discount - $freeShippingDiscount;
            return $base + CartManager::get_pesapal_transaction_fee($base);
        })(),
    ...
    public static function order_insert($order_data): int
    {
        ...
        $or = [
            ...
            'coupon_discount_bearer' => $order_data['coupon_bearer'],
             'order_amount' => (function() use ($order_data) {
            $base = CartManager::cart_grand_total(cartGroupId: $order_data['cart_group_id'], type: 'checked') - $order_data['discount'];
            return $base + CartManager::get_pesapal_transaction_fee($base);
        })(),
