                            ...
                            <div class="tab-content px-lg-3">
                                <div class="tab-pane fade show active text-justify" id="overview"
                                    ...
                                    <div class="row pt-2 specification">
                                        ...
                                        @if($product->video_url != null && (($product->video_provider == 'youtube' && str_contains($product->video_url, "youtube.com/embed/")) || ($product->video_provider == 'tiktok' && str_contains($product->video_url, "tiktok.com/embed/"))))
                                            <div class="col-12 mb-4">
                                                @if($product->video_provider == 'tiktok')
                                    ...
                                    @if (!$product['details'] && ($product->video_url == null || !(($product->video_provider == 'youtube' && str_contains($product->video_url, "youtube.com/embed/")) || ($product->video_provider == 'tiktok' && str_contains($product->video_url, "tiktok.com/embed/")))))
                                        <div>
