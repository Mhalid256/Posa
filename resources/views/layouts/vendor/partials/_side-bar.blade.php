            ...
            <div class="navbar-vertical-footer-offset pb-0">
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if ($sellerPOS == 1 && ($seller->pos_status ?? 0) == 1)
                        ...
                        @if(canAccessModule('order_management'))
                        <li class="nav-item">
                                        ...
                                        <span class="text-truncate">
                                          {{translate('pending')}}
                                            <span class="badge badge-soft-danger badge-pill ml-1">
                                                {{RefundRequest::whereHas('order', function ($query) use ($sellerId) {
                        ...
                        @endif {{-- canAccessModule('order_management') --}}

                        @if(canAccessModule('product_management'))
                        <li class="nav-item">
                        ...
                        @endif {{-- canAccessModule('product_management') --}}

                        @if(canAccessModule('promotion_management'))
                        <li class="nav-item">
                        ...
                        @endif {{-- canAccessModule('promotion_management') --}}

                        @if(canAccessModule('help_and_support'))
                        <li class="nav-item">
                        ...
                        @endif {{-- canAccessModule('help_and_support') --}}

                        @if(canAccessModule('reports_and_analytics'))
                        ...
                        @endif {{-- canAccessModule('reports_and_analytics') --}}

                        {{-- EMPLOYEE MANAGEMENT SECTION --}}
                        @if(canAccessModule('employee_management'))
                        <li class="nav-item">
                            <small class="nav-subtitle">{{translate('employee_management')}}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                        <li class="navbar-vertical-aside-has-menu {{Request::is('vendor/employee*')?'active':''}}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{Request::is('vendor/employee/list')?'active':''}}">
                                    <a class="nav-link" href="{{route('vendor.employee.list')}}" title="{{translate('employee_list')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate text-capitalize">{{translate('employee_list')}}</span>
                                    </a>
                                </li>
                                <li class="nav-item {{Request::is('vendor/employee/add')?'active':''}}">
                                    <a class="nav-link" href="{{route('vendor.employee.add')}}" title="{{translate('add_employee')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate text-capitalize">{{translate('add_employee')}}</span>
                                    </a>
                                </li>
                                <li class="nav-item {{Request::is('vendor/employee/role*')?'active':''}}">
                                    <a class="nav-link" href="{{route('vendor.employee.role.index')}}" title="{{translate('employee_roles')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate text-capitalize">{{translate('employee_roles')}}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        @endif {{-- sellerwise_shipping delivery man --}}
                        @endif {{-- !isVendorEmployee --}}
                    </ul>
                </div>
            </div>
        </div>
