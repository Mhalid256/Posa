                    ...
                    <li class="nav-item">
                        <div class="hs-unfold">
                            <a title="{{translate('website_shop_view')}}"
                               ...
                               href="{{ route('shopView', ['id' => $shop->id ?? 0]) }}"
                        ...
                        <div class="hs-unfold">
                               ...
                               data-hs-unfold-options='{
                                ...
                                <div class="d-none d-md-block media-body text-right">
                                    <h5 class="profile-name mb-0">
                                        {{ $isEmployee ? ($employee->f_name . ' ' . $employee->l_name) : $vendor->name }}
                                        @if($isEmployee)
                                            <span class="badge badge-warning ml-1" style="font-size:10px">{{ translate('staff') }}</span>
                                        @endif
                                    </h5>
                            ...
                            <div id="accountNavbarDropdown"
                                    ...
                                    <div class="media align-items-center text-break">
                                        ...
                                        <div class="media-body">
                                            <span class="card-title h5">
                                                {{ $isEmployee ? $employee->f_name : $vendor->f_name }}
                                            </span>
                                            <span class="card-text">
                                                {{ $isEmployee ? $employee->email : $vendor->email }}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <a class="dropdown-item"
                                   href="{{route('vendor.profile.update',[$vendorId])}}">
            ...
            <div class="p-3">
                ...
                <div class="bg-white p-1 rounded mt-2">
                    <a title="{{('website_shop_view')}}" class="p-2 title-color"
                       href="{{ route('shopView', ['id' => $shop->id ?? 0]) }}" target="_blank" data-toggle="tooltip"
                       data-custom-class="header-icon-title">
